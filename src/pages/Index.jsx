      ...
      <VStack spacing={8} as={Stack} align="stretch">
        ...
        <Box bg={bg} p={8} borderRadius="lg">
          <Center flexDirection="column">
            ...
            <Image src="https://images.unsplash.com/photo-1547147278-b6acb274b6b5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjAwMTl8MHwxfHNlYXJjaHwxfHxjaGluZXNlJTIwYXJ0fGVufDB8fHx8MTY4NTY1NTU5NXww&ixlib=rb-4.0.3&q=80&w=1080" borderRadius="full" boxSize="150px" alt="Dumplings" my={5} />
